...
- [Manage ACP Application with run-script Task](./manage_acp_application_with_run_script.mdx) — end-to-end example using the hub resolver with the `kubectl-app-manager` image
