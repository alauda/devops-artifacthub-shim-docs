...
For example, the Send Mail Task can render `subject`, `body`, and `contentType` from a shared mail template. See [Configure Custom Mail Template](../how_to/configure_custom_mail_template.mdx).
