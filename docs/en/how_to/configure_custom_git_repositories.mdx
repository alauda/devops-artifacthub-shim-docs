...
For the resource manifest structure and the labels and annotations expected on
catalog packages, see [Author Catalog Resources](../catalog/how_to/author_catalog_resources.mdx).
